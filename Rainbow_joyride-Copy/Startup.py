...
def load_images():
    ...
    loading_background = pygame.image.load(
        "projectweek-team_7\\Rainbow_joyride-Copy\\Background\\background\\loadingscreen.png"
    ).convert_alpha()

def load_audio():
    pygame.mixer.music.load("projectweek-team_7\\Rainbow_joyride-Copy\\audio\\replaceholder1.mp3")
